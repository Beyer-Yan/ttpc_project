...
/* Redefinition of the Ethernet driver buffers size and count */   
 #define ETH_RX_BUF_SIZE    324 /* buffer size for receive */
 #define ETH_TX_BUF_SIZE    324 /* buffer size for transmit */
 #define ETH_RXBUFNB        1                   /* 1 Rx buffers of size ETH_RX_BUF_SIZE */
 #define ETH_TXBUFNB        1                   /* 1  Tx buffers of size ETH_TX_BUF_SIZE */
#endif
...
//#define PHY_SPEED_STATUS       ((uint16_t)0x0004) /* PHY Speed mask */
//#define PHY_DUPLEX_STATUS      ((uint16_t)0x0001) /* PHY Duplex mask */
